                ...
                <p>
                  ...
                  <i class="right fa fa-angle-left"></i>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('home') }}" class="nav-link {{!! classActiveSegment(1, 'v1') !!}}">
                    <i class="fas fa-circle"></i>
                    <p>Dashboard v1</p>
                  </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('v2') }}" class="nav-link {{!! classActiveSegment(1, 'v2') !!}}">
                    <i class="fas fa-circle"></i>
                    <p>Dashboard v2</p>
                  </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('v3') }}" class="nav-link {{!! classActiveSegment(1, 'v3') !!}">
                    <i class="fas fa-circle"></i>
                    <p>Dashboard v3</p>
                  </a>
                        </li>
